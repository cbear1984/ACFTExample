            ...
            Box(
                ...
                transition.AnimatedContent(
                    ...
                    Canvas(
                        ...
                        drawRoundRect(
                            color = if (targetState) Color.Cyan else Color.Transparent,
...
fun SegmentedPickerPreview() {
    ...
    val genders by remember { mutableStateOf(genderList) }
    ...
    SegmentedPicker(
        ...
        val color = if (it == selectedGender.value) Color.White else Color.Black
        Row(
